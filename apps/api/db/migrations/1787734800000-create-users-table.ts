 ...
 *
 * The primary key is generated by `uuidv7()`, as everywhere in this schema: the version
 * carries a timestamp in its high bits, so new rows land at the end of the index instead
 * of scattered across it the way a fully random v4 does.
 */
