...
| 27a | T50 | Помилки підготовки в каталозі | `tdd` після Open items; `scaf`, якщо попап — новий компонент з `.html` | `pw` на 1280 і 360 px | — | Додано 2026-09-19. Open items (текст помилки, тултіп чи попап, що рахувати) закрити до кроку А. Варіант з `error_detail` тягне міграцію окремим комітом |
...
| Інструмент | Задачі |
|---|---|
| `/tdd` | T34, T15, T14, T18, T36, T35, T22, T45, T49, T31, T53 |
| `/tdd --review-tests` | T08, T16, T17, T38, T47, T28, T29, T30, T32 |
| `feature-scaffold` | T11, T12, T20, T21, T43, T48, T26 |
| `/goal` | T06, T07, T37, T40, T41, T42, T44, T25, T27 (з `claude-api`) |
| Plan mode | T24, T23, T46, T33 |
| `playwright-cli` | T36, T35, T37, T20, T21, T22, T40, T41, T42, T43, T44, T45, T48, T49, T32, T23, T33 |
| `critical-path-review` | обов'язково: T14, T16, T17, T26, T28, T29, T30 |
| Обв'язка окремим комітом після `/tdd` | T08, T14, T15, T16, T17 |
| `feature-ship` | усі, крім T23, T24, T33, T46 |
| Ручні правки документів до кроку Б | T34 (`openapi.yaml`, `PRD.md`), T35, T36, T37, T40, T41, T42 (`PRD.md`), T43 (`PRD.md`, `sad.md`), T44, T45 (`PRD.md`), T47 (`openapi.yaml`, `PRD.md`), T48, T49 (`PRD.md`), T53 (`openapi.yaml`, `PRD.md`) |
