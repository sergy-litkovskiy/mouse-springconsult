...
| Інструмент | Задачі |
|---|---|
| `/tdd` | T34, T15, T14, T18, T36, T35, T22, T45, T49, T31 |
...
| Ручні правки документів до кроку Б | T34 (`openapi.yaml`, `PRD.md`), T35, T36, T37, T40, T41, T42 (`PRD.md`), T43 (`PRD.md`, `sad.md`), T44, T45 (`PRD.md`), T47 (`openapi.yaml`, `PRD.md`), T48, T49 (`PRD.md`) |
