...
|---|----|--------|--------|-----|-------|---------------|
| 1 | T33 | Приймання поставки 2 | `plan` | `pw` | — | `verification`: живий ключ, недоступна модель, протокол у `_audit/`. Пункти про пошук ціни (AC-08, AC-10b, AC-23–AC-27) виключено разом з T54 |

T50 закрито 2026-09-21.
