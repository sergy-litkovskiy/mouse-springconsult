...
| T32 | [Фронт підготовки](add-preparation-ui.md) | Done | T20, T29, T30, T31, T51, T52, T53 | M | Serhii | — |
...
| T50 | [Помилки підготовки в каталозі](show-preparation-failures-in-catalog.md) | Todo | T29, T32 | M | Serhii | — |
| T54 | [Пошук ціни: порожній діапазон, вартість, таймаут](bound-the-model-call-timeout.md) | Todo | T27 | M | Serhii | — |

## Готові до старту просто зараз

T50 і T54 — жодної незакритої залежності. T33 чекає на обидві.
