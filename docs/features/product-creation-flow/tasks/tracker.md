...
| T32 | [Фронт підготовки](add-preparation-ui.md) | Blocked | T20, T29, T30, T31, T51, T52 | M | Serhii | — |
...
T31, T51, T52 — жодної незакритої залежності.
...
**2026-09-20 знайдено розходження контракту:** `openapi.yaml` має `pendingSuggestions` обов'язковим полем картки, але `api` його не віддає, а Checklist T30 про нього мовчить. Споживає його T32 (п. 6). Заведення окремої бекенд-задачі — рішення 2026-09-20, задача ще не створена.
