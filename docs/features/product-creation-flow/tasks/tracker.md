...
**Готові до старту:** [T55](show-applied-suggestions-in-product-form.md) — форма не показує
тексти, які `api` застосував сам, і «Зберегти» їх стирає. Жодної незакритої залежності.
...
| T55 | [Тексти, застосовані `api`, у формі](show-applied-suggestions-in-product-form.md) | Todo | — | S | — |
