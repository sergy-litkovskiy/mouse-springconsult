...
| T22 | [Каталог](integrate-catalog-with-form-and-delete.md) | Todo | T18, T19, T20, T34 | S | Serhii | — |
...
T21, T22, T24 — жодної незакритої залежності. T24 не залежить від коду поставки 1 і може
