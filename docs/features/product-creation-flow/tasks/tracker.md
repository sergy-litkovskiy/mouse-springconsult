...
**Готові до старту:** T59, T60, T61, T63, T64, T67 — поставка 3, UI каталогу й форми.
...
US-03 і AC-05 так і не переглянули. Задача править лише `ai` і документи, тож нічого не блокує й від
нічого не залежить.
...
Запит 2026-09-21 після приймання поставки 2; T67 додано 2026-09-23. Ланцюжки в `blocked_by` — здебільшого спільні файли
