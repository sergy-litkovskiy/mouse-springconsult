...
| ID | Задача | Статус | blocked_by | Est | Owner | PR |
|----|--------|--------|------|-----|-------|-----|
| T40 | [Компактні фільтри й мітки](compact-catalog-filter-fields.md) | Todo | — | XS | Serhii | — |
| T41 | [Висота ціни у формі](fix-product-form-field-sizing.md) | Blocked | T40 | XS | Serhii | — |
| T42 | [Кольори бейджа готовності](unify-readiness-badge-colors.md) | Blocked | T41 | XS | Serhii | — |
...
T24, T40, T43 — жодної незакритої залежності. T24 не залежить від коду й може вестись
