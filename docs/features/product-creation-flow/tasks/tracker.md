...
| T53 | [Непідтверджені пропозиції](expose-pending-suggestions.md) | Todo | T26, T30 | S | Serhii | — |
| T32 | [Фронт підготовки](add-preparation-ui.md) | Blocked | T20, T29, T30, T31, T51, T52, T53 | M | Serhii | — |
...
| T52 | [Завислі запуски](close-stuck-preparation-runs.md) | Todo | T29 | S | Serhii | — |
...
T52, T53 — жодної незакритої залежності.
