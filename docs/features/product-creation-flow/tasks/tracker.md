...
| T42 | [Кольори бейджа готовності](unify-readiness-badge-colors.md) | Todo | T41 | XS | Serhii | — |
...
T24, T42, T43 — жодної незакритої залежності. T24 не залежить від коду й може вестись
