...
| T44 | [Лінії в діалозі картки](divide-product-form-dialog.md) | Todo | — | XS | Serhii | — |
| T45 | [Результат збереження картки](close-product-form-on-save.md) | Blocked | T44 | S | Serhii | — |
...
T24, T25, T44 — жодної незакритої залежності. Перша хвиля UI-доопрацювання закрита, тож
поставку 2 можна починати; T24 не залежить від коду й може вестись паралельно з T25. Друга
хвиля (T44 → T45) старт поставки 2 не тримає.
