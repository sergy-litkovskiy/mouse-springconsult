...
| T35 | [Фільтр «Картка готова»](add-catalog-readiness-filter.md) | Todo | T34, T36 | XS | Serhii | — |
...
T20, T21, T24, T35 — жодної незакритої залежності. T24 не залежить від коду поставки 1 і може
