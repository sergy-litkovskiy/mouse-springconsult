...
| T37 | [Ширина фільтрів](resize-catalog-filter-fields.md) | Todo | T35 | XS | Serhii | — |
...
T20, T21, T24, T37 — жодної незакритої залежності. T24 не залежить від коду поставки 1 і може
