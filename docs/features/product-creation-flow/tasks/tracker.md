...
| T41 | [Висота ціни у формі](fix-product-form-field-sizing.md) | Todo | T40 | XS | Serhii | — |
...
T24, T41, T43 — жодної незакритої залежності. T24 не залежить від коду й може вестись
