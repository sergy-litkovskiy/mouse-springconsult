...
> **Вихід:** цей файл · [tracker.md](tracker.md) · 76 story у цій теці · [CONTEXT.md](../CONTEXT.md) фічі.
...
| **Поставка 3** | Запит 2026-09-21 після приймання поставки 2: десять правок UI каталогу й форми картки. Пункт 6 (кілька категорій) розрізано на `api` і фронт. Quality gate поставок 1–2 не змінює й від них не залежить. T67 (2026-09-23) — назви Prom/OLX у «Згенерувати все». T68–T74 (2026-09-23) — десять правок форми картки: дефект опису Prom, місце «Згенерувати все», ID з копіюванням, два режими AI для поля з кнопками, остання пропозиція на поле. T75–T76 (2026-09-25) — компактніший шрифт і кадри картки 120×120 | T56–T76 | ~11.4 д |
...
**Граф ациклічний.** Перевірено топологічним сортуванням: усі 76 вершин потрапляють у
...
править той самий `app-suggestion-field`. Нові AC-50…AC-71 кожна story вносить у PRD §5 сама; T67
...
`product-gallery.css`, яких не чіпає жодна інша відкрита задача.
