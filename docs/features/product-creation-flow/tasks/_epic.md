...
`latestSuggestions`. T75 і T76 (запит 2026-09-25) ребер не мають: вони правлять лише `styles.css` і
`product-gallery.css`, яких не чіпає жодна інша відкрита задача. Ребро T69 → T77 — теж спільні
