...
> **Вихід:** цей файл · [tracker.md](tracker.md) · 77 story у цій теці · [CONTEXT.md](../CONTEXT.md) фічі.
...
| **Поставка 3** | Запит 2026-09-21 після приймання поставки 2: десять правок UI каталогу й форми картки. Пункт 6 (кілька категорій) розрізано на `api` і фронт. Quality gate поставок 1–2 не змінює й від них не залежить. T67 (2026-09-23) — назви Prom/OLX у «Згенерувати все». T68–T74 (2026-09-23) — десять правок форми картки: дефект опису Prom, місце «Згенерувати все», ID з копіюванням, два режими AI для поля з кнопками, остання пропозиція на поле. T75–T76 (2026-09-25) — компактніший шрифт і кадри картки 120×120. T77 (2026-09-25) — рівні відступи й сіра підказка в картці | T56–T77 | ~11.6 д |
...
flowchart LR
  ...
  subgraph P3["Поставка 3 — UI каталогу й форми"]
    ...
    T75[T75 компактніший шрифт]
    T76[T76 кадри 120×120]
    T77[T77 рівні відступи картки]
  end
...
поставка 3
рівень  0 │ T56  T57  T58  T59  T60  T61  T63  T64  T67  T68  T69  T70  T71  T75  T76
рівень  1 │ T62  T65  T72  T77
рівень  2 │ T73
рівень  3 │ T66  T74
```
...
Рівні 1–3 дає ланцюжок AI-кнопок T67, T71 → T72 → T73 → T66, T74; T77 стоїть на рівні 1
за T69. Усередині
поставки рівень 0 — п'ятнадцять незалежних задач, але спільні файли (`product-catalog.*`,
...
**Граф ациклічний.** Перевірено топологічним сортуванням: усі 77 вершин потрапляють у
...
править той самий `app-suggestion-field`. Нові AC-50…AC-72 кожна story вносить у PRD §5 сама; T67
ще й переписує AC-05, T72 — AC-21. T74 замінює в контракті читання картки `pendingSuggestions` на
`latestSuggestions`. T75 і T76 (запит 2026-09-25) ребер не мають: `product-gallery.css` з T76
не чіпає жодна інша відкрита задача, а `styles.css` з T75 править ще T77, але в іншому блоці —
токени шрифту в `:root` проти обгортки підказки й помилки поля. Ребро T69 → T77 — теж спільні
`product-form.*`: T69 переносить «Згенерувати все» під галерею й підганяє відступи `.card-prepare`,
а T77 зводить до одного кроку всі відступи форми, тож рівняє вже зсунуті блоки.
...
| [T75](compact-app-typography.md) | Компактніший шрифт: шкала токенів Material на крок менша | — | XS | Serhii |
| [T76](shrink-card-gallery-frames.md) | Кадри галереї картки 120×120 | — | XS | Serhii |
| [T77](even-out-card-form-spacing.md) | Рівні відступи й сіра підказка в картці товару | T69 | XS | Serhii |
