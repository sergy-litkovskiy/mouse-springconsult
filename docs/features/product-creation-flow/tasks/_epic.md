...
| **Поставка 3** | Запит 2026-09-21 після приймання поставки 2: десять правок UI каталогу й форми картки. Пункт 6 (кілька категорій) розрізано на `api` і фронт. Quality gate поставок 1–2 не змінює й від них не залежить | T56–T66 | ~7 д |
...
поставка 3
рівень  0 │ T56  T57  T58  T59  T60  T61  T63  T64
...
поставки рівень 0 — вісім незалежних задач, але спільні файли (`product-catalog.*`,
...
Нові AC-50…AC-60 кожна story вносить у PRD §5 сама.
