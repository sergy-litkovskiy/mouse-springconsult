...
| **Поставка 1 — доопрацювання каталогу** | Запит 2026-09-16: фільтр за готовністю, підписи й ширина фільтрів. T23 не блокує: каталог уже працює, а нові задачі не змінюють жодного quality gate поставки | T34–T37 | ~1.6 д |
