...
| **Поставка 2** | Модель: тексти, діапазон ціни, пропозиції, вартість картки, черга й `worker` | T24–T33, T50–T52 | ~10.5 д |
...
| [T32](add-preparation-ui.md) | Фронт підготовки: запуск, полінг, пропозиції, вартість | T20, T29, T30, T31, T51, T52 | S | Serhii |
