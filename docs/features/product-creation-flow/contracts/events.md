...
одного `worker` це рідкість, і повтор тут є дією людини. Те саме стається, коли впаде сам
`abandon`. Обидва шляхи закриває обхід завислих запусків — [T52](../tasks/close-stuck-preparation-runs.md).
