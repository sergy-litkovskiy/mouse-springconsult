...
пропозиція праворуч), кнопкою «Generate all» і кнопками «? -> AI» / «<- AI» на кожному полі
(T32) — деталі в §6, сценарій 10.
...
sequenceDiagram
    ...
    api->>pg: читає тексти картки (заголовок, опис) — вхід підбору ціни
